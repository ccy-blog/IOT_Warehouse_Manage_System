...
int cgiMain()
{
	...
	fprintf(cgiOut, "<meta http-equiv=\"refresh\" content=\"1; url=../control1.html\">");
	fprintf(cgiOut, "<H2>设置<font color=\"#FF0000\" size=\"+3\">成功！</font>本页面1秒后自动关闭。</H2>");
...
err:
	...
	fprintf(cgiOut, "<BODY BGCOLOR=\"#EEF2FB\">"); 
	fprintf(cgiOut, "<meta http-equiv=\"refresh\" content=\"1; url=../control1.html\">");
	fprintf(cgiOut, "<H2>设置<font color=\"#FF0000\" size=\"+3\">失败！</font>未知错误，请重试！本页面1秒后自动关闭。</H2>");
